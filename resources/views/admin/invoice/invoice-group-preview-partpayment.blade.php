                                                ...
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td style=" line-height: 1.8;"><strong style="font-size: 15px;">Invoice Date</strong> <br>
                                                            <?= isset($bookingDetails->invoiceOverride->invoice_date) ? showStandardDate($bookingDetails->invoiceOverride->invoice_date) : showStandardDate($bookingDetails->invoice_date) ?> 
                                                        </td>
                                                    </tr>
                                                    <tr>
    ...
    <!--                                                <td style="text-align: left; padding-top: 10px; border-bottom: 1px solid #ccc; padding-bottom: 10px;">{{ date('d-m-Y',strtotime($val->booking_time)) }} </td>
                                        ...
                                        @php $part_payment_tot = 0; @endphp
                                            ...
                                            @foreach($partPayments as $partPayment)
                                                ...
                                                <tr>                                                    
                                                    <td colspan="6" style="width: 60px; text-align: right; padding-top: 10px; border-bottom: 1px solid #ccc; padding-bottom: 10px;">Payment on {{ showDate($partPayment->payment_time) }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 60px; text-align: right; padding-left: 5px; padding-top: 10px;  padding-bottom: 10px; font-weight: 600;"><strong><?= env('CURRENCY_SYM') ?> <?= $total_gbp ?>
                                                </strong>
                                            </td>
                                        </tr>                                                                                                                                           
                                    </table>
