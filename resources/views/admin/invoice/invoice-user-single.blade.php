                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td style="font-size: 14px;line-height: 1; color: #424242; text-transform: capitalize;">
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    <tr>
                                                        <td style="width: 182px; padding-bottom: 10px; ">{{ ucfirst($model->client->name) }}</td>
                                                    </tr>
                                        ...
                                        <tr>
                                            <td style="font-size: 12px;line-height: 1; color: #424242; text-transform: capitalize; vertical-align: top;">
                                                <table width="100%" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td style=" line-height: 1.8;"><strong style="font-size: 15px;">Invoice Date</strong> <br> {{ date("dS M Y") }}</td>
                                                    </tr>
                                                    <tr>
<!--                                                        <td style="line-height: 1.8;"><strong style="font-size: 15px;">Invoice Number </strong> <br>  </td>-->
                                                    </tr>
                                                    
                                                    <tr>
                                                        <td style="line-height: 1.8;"><strong style="font-size: 15px;">Vat Number</strong> <br>{{ $model->companyInfo->vat_number }}</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <table width="100%" cellpadding="0" cellspacing="0">
                                                                ...
                                                                <tr>
                                                                    <td style="margin-bottom: 10px; display: block;">{{ $model->franchisees->base_location }}</td>
                                                                </tr>
...
<!--                                            <th style=" font-size: 12px; text-align: left; border-bottom: 1px solid #000; padding-bottom: 10px; ">Booking Date&nbsp;&nbsp;</th>
                                            ...
                                            <th  colspan="4"  style=" font-size: 12px; text-align: left; border-bottom: 1px solid #000; padding-bottom: 10px; ">Description</th>
                                        ...
                                        <tr>
<!--                                            <td style="text-align: left; padding-top: 10px; border-bottom: 1px solid #ccc; padding-bottom: 10px;">{{ date('d-m-Y',strtotime($model->booking_time)) }} </td>
                                            <td style="text-align: left; padding-top: 10px; border-bottom: 1px solid #ccc; padding-bottom: 10px;">
                                                {{ $model->order_id }}  
                                            </td>-->
                                            <td colspan="4" style="text-align: left; padding-top: 10px; border-bottom: 1px solid #ccc; padding-bottom: 10px;">
                                            ...
                                            <td style="width: 100px; text-align: right; padding-left: 5px; padding-top: 10px; border-bottom: 1px solid #ccc; padding-bottom: 10px;">
                                                ...
                                                $vat_status =  $model->vat_registered;
                                                if ($vat_status) {
                                        ...
                                        <?php
                                        foreach ($model->invoice as $customInvoice) {
...
<!--                                                <td></td>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td colspan="6" style="width: 100px; text-align: right; padding-top: 10px;  padding-bottom: 10px;">Subtotal</td>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td colspan="6" style="width: 60px; text-align: right; padding-top: 10px; border-bottom: 1px solid #ccc; padding-bottom: 10px;">Total VAT</td>
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td></td>
                                            <td colspan="4" style="width: 60px; text-align: right; padding-top: 10px; padding-bottom: 10px; text-transform: uppercase; font-weight: 600;"><strong>Total GBPT</strong></td>
            ...
            <tfoot style="">
                ...
                <tr>
                    <td style="padding: 35px 15px; font-size: 13px; color: #666; background: #fff;">
                        <table width="100%" cellpadding="0" cellspacing="0" style="color: #424242;">
                            <tr>
                                <td style="font-weight: 600;">Due Date: {{ date("d F Y") }}</td>
                            </tr>
                            <tr>
                                <td>   Sort Code: {{ $model->franchisees->bank_sortcode }}</td>
                            </tr>
                            <tr>
...
<!--                                    Company Registration No: 09068518.  -->
                                    Registered Office: {{ $model->companyInfo->business_address }}
                                </td>
                            </tr>
