    ...
    <div class="col-md-12 ">
        <div class="portlet box green ">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i> Update Franchisor</div>
            ...
            <div class="portlet-body form">
                {!! Form::model($model, ['method' => 'PATCH','files' => true , 'route' => ['franchisor.update', $model->id], 'class'=>'form-horizontal']) !!}
                <div class="form-body">
                    ...
                    <fieldset class="address">
                        ...
                        <div class="col-md-9">
                            ...
                            {!! Form::text('locality', null, array('placeholder' => 'House Number','class' => 'form-control places-autocomplete','id' => 'Street2','autocomplete'=>"address-line2" )) !!}
                            <span class="bg-danger"><?= $errors->first('locality'); ?></span>
                        </div>
                    </div>
...
<!--                            {!! Form::text('street', null, array('placeholder' => 'Street','class' => 'form-control')) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            {!! Form::text('town', null, array('placeholder' => 'City','class' => 'form-control places-autocomplete','id' => 'City','autocomplete'=>"address-line2" )) !!}
                            <span class="bg-danger"><?= $errors->first('town'); ?></span>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            ...
                            {!! Form::text('country', null, array('placeholder' => 'Country','class' => 'form-control places-autocomplete','id' => 'Country','autocomplete'=>"country" )) !!}
                            <span class="bg-danger"><?= $errors->first('country'); ?></span>
...
<!--                            {!! Form::select('country',getCountry(false), 'United Kingdom' ,array('placeholder' => 'Please Select','class' => 'form-control')) !!}
                        ...
                        <div class="col-md-9">
                            <fieldset class="scheduler-border">
                                ...
                                <?php foreach ($allrole as $key => $role) {
                                    ...
                                    <div class="col-md-4">
                                        <label>
                                            {{ Form::checkbox('role_id[]',$role->id,in_array($role->id, $userRole),["class"=>"icheck checkSingle",  "data-checkbox"=>"icheckbox_square-blue"]) }}
                                            <?= $role->name ?>
                                        </label>
                                    </div>
                                <?php } ?>
                ...
                <div class="form-actions right1">
                    ...
                    <a href="{{route('franchisor.index')}}" class="btn btn-danger">Cancel</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
