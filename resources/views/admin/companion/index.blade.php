...
@section('body')
    ...
    <h1 class="page-title">Companion
        ...
        <a href="{{ route('companion.create') }}" class="btn btn-primary float-right"> Create </a>
        @endif
        */?>
    ...
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="portlet box purple ">
                        ...
                        <div class="portlet-body form" style="display: <?= isset($_GET['advanceSearch']) ? "block" : "none" ?>">
                            ...
                            {!! Form::open(['method'=>'GET','url'=>route('companion.index'),'class'=>'form-horizontal','role'=>'search'])  !!}
            ...
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs"></i>Manage Companion</div>
...
<!--                                <td>{{ $model->phone }}</td>-->
                                ...
                                <ul>
                                    ...
                                    <li>
                                        @if(permit(['companion.show']))
                                        <a class="btn btn-info btn-xs" href="{{ route('companion.show',$model->id) }}" title="View">
                                    ...
                                    <li>
                                        ...
                                        <a class="btn btn-primary btn-xs" href="{{ route('companion.edit',$model->id) }}"title="Edit"><i class="fa fa-pencil" aria-hidden="true"></i>
                                        </a>
                                        @endif
                                    </li>
                                    ...
                                    <li>
                                        @if(permit(['companion.destroy']))
                                            {!! Form::open(['method' => 'DELETE','route' => ['companion.destroy', $model->id],'style'=>'display:inline', 'onsubmit'=>"return confirm('Are you sure?')"  ]) !!}
