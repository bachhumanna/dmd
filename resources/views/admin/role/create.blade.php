    ...
    <div class="col-md-12 ">
        <div class="portlet box green ">
            ...
            <div class="portlet-body form">
                {!! Form::open(array('route' => 'role.store', 'files' => true ,'method'=>'POST','class'=>'form-horizontal')) !!}
                <div class="form-body">
                        ...
                        <?php foreach ($finalPermission as $key => $per) { ?>
                            <fieldset class="scheduler-border">
                                ...
                                <?php foreach ($per as $key => $permission) {
                                    ...
                                    <div class="col-md-4">
                                        <label>
                                            <input  name="rolePermission[]"  value="<?= $permission->id ?>" type="checkbox" class="icheck checkSingle"  data-checkbox="icheckbox_square-blue"> <?= $permission->display_name ?>
                                        </label>
                                    </div>
