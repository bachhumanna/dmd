                                ...
                                <table class="table table-bordered table-striped table-condensed flip-content">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                {!! Form::text('registered_office',null ,array('class' => 'form-control', 'id' => 'registered_office')) !!}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php 
                                                    $incorporation_date =  \Carbon\Carbon::parse($model->incorporation_date)->format('d-m-Y');                                                    
                                                @endphp

                                                {!! Form::text('incorporation_date',$incorporation_date ,array('class' => 'form-control date-picker','data-date-format'=>"dd-mm-yyyy")) !!}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php 
                                                    $year_end =  \Carbon\Carbon::parse($model->year_end)->format('d-m-Y');                                                    
                                                @endphp

                                                {!! Form::text('year_end', $year_end ,array('class' => 'form-control date-picker','data-date-format'=>"dd-mm-yyyy")) !!}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php 
                                                    $confirmation_statement_date =  \Carbon\Carbon::parse($model->confirmation_statement_date)->format('d-m-Y');                                                    
                                                @endphp

                                                {!! Form::text('confirmation_statement_date', $confirmation_statement_date ,array('class' => 'form-control date-picker','data-date-format'=>"dd-mm-yyyy")) !!}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php 
                                                    $account_filling_date =  \Carbon\Carbon::parse($model->account_filling_date)->format('d-m-Y');                                                    
                                                @endphp

                                                {!! Form::text('account_filling_date', $account_filling_date ,array('class' => 'form-control date-picker','data-date-format'=>"dd-mm-yyyy")) !!}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php 
                                                    $hmrc_filling_date =  \Carbon\Carbon::parse($model->account_filling_date)->format('d-m-Y');                                                    
                                                @endphp

                                                {!! Form::text('hmrc_filling_date', $hmrc_filling_date ,array('class' => 'form-control date-picker','data-date-format'=>"dd-mm-yyyy")) !!}
                                            ...
                                            <tbody class="directorTbody">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <img class="img afterUpload" src="{{ asset('admin/directors_image/'.$data->director_image) }}" style="height: 100px;width: 100px">
                                                        <?php } ?>
                                                    </td>
                                    ...
                                    <tbody>
                                        ...
                                        <?php if (count($model->vatreg)) { ?>
                                            ...
                                            foreach ($model->vatreg as $key => $data) {
                                                ...
                                                <tr class="vat_details">
                                                    ...
                                                    <td>
                                                        @php 
                                                            $vat_reg_date =  \Carbon\Carbon::parse($data->vat_reg_date)->format('d-m-Y');                                                            
                                                        @endphp

                                                        {!! Form::text('vat_reg_date[]',$vat_reg_date ,array('class' => 'form-control date-picker','data-date-format'=>"dd-mm-yyyy")) !!}
                                                    ...
                                                    <td>
                                                        @php 
                                                            $vat_de_reg_date =  \Carbon\Carbon::parse($data->vat_de_reg_date)->format('d-m-Y');                                                            
                                                        @endphp

                                                        {!! Form::text('vat_de_reg_date[]',$vat_de_reg_date ,array('class' => 'form-control date-picker','data-date-format'=>"dd-mm-yyyy")) !!}
                                        ...
                                        <?php } else { ?>
                                            <tr class="vat_details">
                                                <td>VAT Registration Date</td>
                                                <td>
                                                    {!! Form::text('vat_reg_date[]',null ,array('class' => 'form-control date-picker','data-date-format'=>"dd-mm-yyyy")) !!}
                                                    <!-- <span class="bg-danger"><?= $errors->first('vat_registration_date'); ?></span> -->
                                                    <span class="bg-danger"><?= $errors->first('vat_reg_date'); ?></span>
                                                </td>
                                                <td>VAT De-registration Date</td>
                                                <td>
                                                    {!! Form::text('vat_de_reg_date[]',null ,array('class' => 'form-control date-picker','data-date-format'=>"dd-mm-yyyy")) !!}
                                                    <span class="bg-danger"><?= $errors->first('vat_dereg_date'); ?></span>
                                                </td>
                                                <td>
                                                    <div class="col-md-1">
                                ...
                                <table class="table table-bordered table-striped table-condensed flip-content">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                @php 
                                                    $public_liability_insurance =  \Carbon\Carbon::parse($model->franchisees->public_liability_insurance)->format('d-m-Y');                                                    
                                                @endphp

                                                {!! Form::text('public_liability_insurance', $public_liability_insurance, array('placeholder' => 'Public Liability Insurance','class' => 'form-control date-picker','data-date-format'=>"dd-mm-yyyy")) !!}
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @php 
                                                    $employers_liability_insurance =  \Carbon\Carbon::parse($model->franchisees->employers_liability_insurance)->format('d-m-Y');                                                    
                                                @endphp

                                                {!! Form::text('employers_liability_insurance', $employers_liability_insurance, array('placeholder' => 'Employers Liability Insurance','class' => 'form-control date-picker','data-date-format'=>"dd-mm-yyyy")) !!}
...
google.maps.event.addDomListener(window, 'load', function () {
    ...
    dropAutocomplete = new google.maps.places.Autocomplete(document.getElementById('registered_office'), options);
});</script>
...
<script>
    $(document).on('click', '.new-row', function () {
        $('<tr class="loopTableArea"><td>VAT Registration Date</td><td><input type="text" class="form-control date-picker" placeholder="" name="vat_reg_date[]",data-date-format ="dd-mm-yyyy"></td> <td style="width: 20%">VAT De-registration Date</td><td><input type="text" class="form-control date-picker" placeholder="" name="vat_de_reg_date[]"></td></tr>').appendTo('#vatregdate').hide().fadeIn(280);
