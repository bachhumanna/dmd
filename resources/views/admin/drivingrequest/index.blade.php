...
@section('body')
    ...
    <h1 class="page-title">Driving Request
        <small></small>
        <a href="{{ route('driving-request.create') }}" class="btn btn-primary float-right"> Create </a>
    </h1>
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="portlet box purple ">
                        ...
                        <div class="portlet-body form" style="display: <?= isset($_GET['advanceSearch']) ? "block" : "none" ?>">
                            ...
                            {!! Form::open(['method'=>'GET','url'=>route('driving-request.index'),'class'=>'form-horizontal','role'=>'search'])  !!}
            ...
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cogs"></i>Manage Driving Request </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td  class="align-center">
                                    <a class="btn btn-info" href="{{ route('driving-request.show',$model->id) }}">Show</a>
<!--                                    <a class="btn btn-primary" href="{{ route('driver.edit',$model->id) }}">Edit</a>-->
