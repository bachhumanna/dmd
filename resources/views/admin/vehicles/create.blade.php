...
<!--                    < ?php pr($errors->all()) ?>-->
                    ...
                    <div class="form-group" style='display:none'>
                        ...
                        <div class="col-md-9">
                            ...
                            <span class="bg-danger"><?= $errors->first('body_type'); ?></span>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            {!! Form::text('vehicles_company', null, array('placeholder' => 'Vehicles Make','class' => 'form-control')) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            {!! Form::text('vehicles_number', null, array('placeholder' => 'Plate Number','class' => 'form-control')) !!}
                            <span class="bg-danger"><?= $errors->first('vehicles_number'); ?></span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-md-3 control-label">Licence Capacity (to carry set number of passengers) </label>
                        <div class="col-md-9">
                            {!! Form::selectRange('max_capacity', 2,10, 4,array('class' => 'form-control')) !!}
                            <span class="bg-danger"><?= $errors->first('max_capacity'); ?></span>
                        </div>
                    </div>

                    <div class="form-group">
                        <label class="col-md-3 control-label">PHV Licence Number</label>
                        <div class="col-md-9">
