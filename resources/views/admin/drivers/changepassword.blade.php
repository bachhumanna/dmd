            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    <div class="form-group" style="display:none">
                        ...
                        <div class="col-md-9">
                            {!! Form::password('current_password', null, array('placeholder' => 'current_password','class' => 'form-control')) !!}
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-9">
                            {!! Form::password('re_password', null, array('placeholder' => 're_password','class' => 'form-control date-picker')) !!}
