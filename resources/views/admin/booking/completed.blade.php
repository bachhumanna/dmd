...
<div class="row">
    <div class="col-md-12">
            ...
            <div class="col-md-12">
                <div class="portlet box purple ">
                    ...
                    <div class="portlet-body form" style="display: none;">
                        {!! Form::open(['method'=>'GET','url'=>route('booking.completed'),'class'=>'form-horizontal','role'=>'search'])  !!}
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>Completed </div>
            </div>
                  ...
                  <table class="table table-bordered table-striped table-condensed flip-content">
                    <thead class="flip-content">
                        <tr>
                            ...
                            <th  class="table-totle-id">@sortablelink('total_duration','Total Time')</th>

                            <th class="table-bookin-base">@sortablelink('base_location','Base')</th>
                            <th>Address</th>                            
                            <th>@sortablelink('client_id','Mobile')</th>
                            <th  class="table-bookin-destination">@sortablelink('drop_location','Destination')</th>
                            <th class="table-bookin-status">@sortablelink('payment_status','Status')</th>
