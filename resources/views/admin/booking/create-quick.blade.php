                        ...
                        <fieldset class="scheduler-border col-md-9 col-md-offset-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    ...
                                    {!! Form::text('booking_time', $date, array('placeholder' => 'Booking Date Time','class' => 'form-control date-picker-booking_time update-details', "autocomplete"=>"off", 'id' => 'booking_time')) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    {!! Form::text('pickup_location[1]', null, array('placeholder' => 'Address 1','class' => 'form-control update-details','id' => 'pickup_location1','onfocus'=>'allowForLocation(1)','onChange'=>"distanceCalculator(1)")) !!}
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="form-group hideforQuickBook">
                                <label class="col-md-3 control-label">Address 2</label>
                                <div class="col-md-5">
                                    {!! Form::text('pickup_location[2]', null, array('placeholder' => 'Address 2','class' => 'form-control update-details','id' => 'pickup_location2','onfocus'=>'allowForLocation(2)', 'onChange'=>"distanceCalculator(2)")) !!}
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="form-group hideforQuickBook">
                                ...
                                <div class="col-md-5">
                                    {!! Form::text('pickup_location[3]', null, array('placeholder' => 'Address 3','class' => 'form-control update-details','id' => 'pickup_location3','onfocus'=>'allowForLocation(3)'  ,'onChange'=>"distanceCalculator(3)")) !!}
                                </div>
                                <div class="col-md-2">
