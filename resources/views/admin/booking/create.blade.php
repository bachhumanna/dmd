                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        <fieldset class="scheduler-border col-md-9 col-md-offset-3">
                            ...
                            <div id="bookindDateDiv" style="display:none">
                                <div class="form-group late_booking_container">
                                    <label class="col-md-3 control-label">Booking Date</label>

                                    <div class="col-md-3">
                                        {!! Form::text('created_at', null, array('placeholder' => 'Booking Date','class' => 'form-control date-picker ', "autocomplete"=>"off", 'id' => 'created_at')) !!}
                                        <span class="bg-danger validation_error error_created_at"><?= $errors->first('created_at'); ?></span>
                                    </div>
                                    <div class="col-md-6">
                                        {!! Form::text('late_booking_reason', null, array('placeholder' => 'Reason for late booking','class' => 'form-control', "autocomplete"=>"off", 'id' => 'late_booking_reason')) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div id="invoiceTo" style="display:none">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    {!! Form::select('base_return',[ 0=>"No", 1=>'Yes'], null ,array('class' => 'form-control base_return','onchange'=>'longReturn(this.value)')) !!}
                    ...
                    <div class="form-group">
                        <fieldset class="scheduler-border col-md-9 col-md-offset-3 addRight">
                            ...
                            <div class="repeat-type-all custom">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3" id="link-list">
                                    </div>
                                </div>
                            </div>
...
$(document).on('click', '.new-row-weekly', function () {
    $('<div class="row"><div class="col-md-5">{{ Form::select("repet_days[]", $days,null,array("class" => "form-control mt10")) }}</div><div class="col-md-5 mt10">{!! Form::text("repet_times[]", null, array("class" => "form-control time-picker")) !!}</div></div>').appendTo('#weekly').hide().fadeIn(280);
//    $('.date-picker').datetimepicker({
//        autoclose: true
//    });
...
<script>
    ...
    function distanceCalculator(id) {
        ...
        if(booking_time.split(' ')[0] < moment(curDate).format('MM/DD/YYYY')){

            $("#bookindDateDiv").show();
        }else{

            jQuery('#created_at' ).val('');
            jQuery("#bookindDateDiv").hide();
        }
...
//        } else {
    ...
    /*$('#booking_time').click(function () {
        ...
        if(booking_time.format("dd-mm-yyyy") < d){
            $("#bookindDateDiv").show();
        }
    });*/
    ...
    $(".date-picker-booking_time").on("dp.change", function (e) {
        ...
        console.log(moment(curDate).format('MM/DD/YYYY'));
    ...
    $("#booking_form :input").attr("autocomplete", "off");
</script>
@endsection
