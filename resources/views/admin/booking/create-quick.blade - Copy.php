                    ...
                    <div class="form-group">
                        <fieldset class="scheduler-border col-md-9 col-md-offset-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('booking_time', null, array('placeholder' => 'Booking Date Time','class' => 'form-control date-picker-booking_time', "autocomplete"=>"off", 'id' => 'booking_time')) !!}
...
<!--                                <label class="col-md-2 control-label">Late Booking</label>
                            ...
                            <div class="form-group franchiseaddress">
                                ...
                                <div class="col-md-9">
                                    {!! Form::text('base_location', $franchiseeModel->base_location, array('placeholder' => 'Base Location','class' => 'form-control','id'=>'base_location')) !!}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    {!! Form::text('pickup_location[1]', null, array('placeholder' => 'Pickup 1','class' => 'form-control','id' => 'pickup_location1','onfocus'=>'allowForLocation(1)','onChange'=>"distanceCalculator(1)")) !!}
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="form-group"  style="display:none">
                                ...
                                <div class="col-md-5">
                                    {!! Form::text('pickup_location[2]', null, array('placeholder' => 'Pickup 2','class' => 'form-control','id' => 'pickup_location2','onfocus'=>'allowForLocation(2)', 'onChange'=>"distanceCalculator(2)")) !!}
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="form-group"  style="display:none">
                                ...
                                <div class="col-md-5">
                                    {!! Form::text('pickup_location[3]', null, array('placeholder' => 'Pickup 3','class' => 'form-control','id' => 'pickup_location3','onfocus'=>'allowForLocation(3)'  ,'onChange'=>"distanceCalculator(3)")) !!}
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-5">
                                    {!! Form::text('drop_location', null, array('placeholder' => 'Destination','class' => 'form-control ','id' => 'drop_location',  'onChange'=>"distanceCalculator(4)" )) !!}
...
<script>
    ...
    function distanceCalculator(id) {
        ...
        //alert(new Date(2019, 2 , 12, 02 , 47, 00, 0));
        //alert(new Date(booking_time));
        //exit();
        // Tue Mar 12 2019 02:47:00 GMT+0530 (India Standard Time)
        ...
        service.getDistanceMatrix({
            ...
            drivingOptions: {
                ...
                departureTime: new Date(Date.parse(booking_time)),
