    ...
    <div class="col-md-12 ">
        <div class="portlet box green ">
            ...
            <div class="portlet-body form">
                {!! Form::open(array('route' => 'franchisor-fees-store', 'files' => true ,'method'=>'POST','class'=>'form-horizontal')) !!}
                ...
                <div class="form-body">
                    ...
                    <div class="form-group" id="months" style="display: {{ in_array(Request::old('type'),[2,3]) ? "block":"none" }} ">
                        <label class="col-md-3 control-label">Month</label>
                        <div class="col-md-9">
                            {{ Form::selectMonth('months[]', date('m'), array('class' => 'form-control','multiple' => 'multiple'))}}
