                    ...
                    <div class="form-group">
                        <fieldset class="scheduler-border col-md-9 col-md-offset-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    {!! Form::text('licence_expiry_date', $model->userDriverdetails->licence_expiry_date ,array('placeholder' => 'Expiry Date','class' => 'form-control date-picker', 'data-date-format'=>"yyyy-mm-dd")) !!}
                                            ...
                                            <tbody>
                                              ...
                                              <?php } ?>
                                                ...
                                                <tr class='clone_element'>
                                                    ...
                                                    <td>
                                                        {!! Form::text('certificate_expiry_date[]', null, array('data-date-format'=>"yyyy-mm-dd",'placeholder' => 'Certificate Expiry Date','class' => 'form-control date-picker')) !!}
                                                        <span class="bg-danger"><?= $errors->first('phl_expiry_date'); ?></span>
                                                    </td>
                                                    <td colspan="2">
